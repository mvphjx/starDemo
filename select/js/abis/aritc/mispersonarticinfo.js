...
{
		aritcPersonTableMgr:function(type,id,pageNumStr,gid)
		{
			var where = null;
...
//					link:{cols:["CARD_NUM"],callBack:clickLink},
		...
		webSearchMgr:function(type,id,tarr,searchStr)
		{
			if(type == "zhanghaoId")
			{
				var tarr = 
	        		[
	        			{colName:"IM_TYPE",dispName:tarr.IM_TYPE,dataType:ABISCode.StorageDataType.STRING,codeName:null},
...
//	        			{colName:"IM_ID",dispName:tarr.IM_ID,dataType:ABISCode.StorageDataType.STRING,codeName:null},
			...
			if(type == "gruopMesId")
			{
				var tarr = 
	        		[
	        			{colName:"IM_TYPE",dispName:tarr.IM_ID,dataType:ABISCode.StorageDataType.STRING,codeName:null},
	        			{colName:"GROUP_NO",dispName:tarr.GROUP_NO,dataType:ABISCode.StorageDataType.STRING,codeName:null},
	        			{colName:"SEX_CODE",dispName:tarr.SEX_CODE,dataType:ABISCode.StorageDataType.UNKNOWN,codeName:"MIS_PERSON_BASIC_INFO|SEX_CODE"},
...
//	        			{colName:"IM_ID",dispName:tarr.IM_ID,dataType:ABISCode.StorageDataType.STRING,codeName:null},
	        			...
	        			{colName:"CREATE_TIME",dispName:tarr.CREATE_TIME,dataType:ABISCode.StorageDataType.DATE,codeName:null},
	        			{colName:"SEX_CODE",dispName:tarr.SEX_CODE,dataType:ABISCode.StorageDataType.STRING,codeName:null},
