var ABISCode=
{
	...
	CodeDispStyleType: //代码表展示的类型
	{
		VALUE:5,
	    CODE : 6
	},
	BaseUnitCode:100000000000,
	MaskIndex:[1,2,3,4],
	PrivObjType:{
        ALL : 0,
		SYSTEM_TYPE : 1,
	...
	PrivObjId:{
		...
		ROLE : 31,
		HITLOG_LTL : 50,
		SYS_PARAM_DB_CATLOG : 110,
		SYS_PARAM_MATCH_PART : 111
	},
	UserPriv:{
        PRIV_ALL : 0,
		DATA_ADD : 1,
...
2认定界面 比对任务过滤
*/
ABISCode.MatchCheckAllowStatus = [];
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.SEARCHED);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.WAITCENSOR);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.WAITRECHECK);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.WAITCHECK);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.CENSORFIN);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.WAITGACHECK);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.GACHECKING);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.CHECK_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.CHECK_NOT_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.RECHECK_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.RECHECK_NOT_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.GACHECK_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.GACHECK_NOT_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.AUDIT_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.AUDIT_NOT_HIT);
ABISCode.MatchCheckAllowStatus.push(ABISCode.QryStatusCode.UNKNOWN);
ABISCode.MatchCheckAllowBty=[ABISCode.Bty.BTY_UNKNOWN,ABISCode.Bty.BTY_FINGER,ABISCode.Bty.BTY_PALM];
