...
HpfUtil.prototype.num  = 1;
HpfUtil.prototype.tpdb = null;
HpfUtil.prototype.tpdbId = null;
HpfUtil.prototype.lpdb = null;
HpfUtil.prototype.lpdbId = null;
HpfUtil.prototype.param = null;

function HpfUtil(data)
{
	this.data = data;
	this.init(this.data);
}

HpfUtil.prototype.init = function(data)
{
	data = eval('(' + data + ')');
...
HpfUtil.prototype.addNist = function()
{
	if(this.num > 7)
	{
...
HpfUtil.prototype.removefpt = function(obj)
{
	$(obj).parent().parent().remove(); 
	this.num--;
}

HpfUtil.prototype.removeAll = function()
{
...
HpfUtil.prototype.addTPDB = function()
{
	var _this = this;
	if(this.tpdb == null)
	{
...
HpfUtil.prototype.addLPDB = function()
{
	var _this = this;
	if(this.lpdb == null)
	{
...
HpfUtil.prototype.zrdlclick = function()
{
	if($("#zrdlId").is(":checked"))
	{
		$("#yxjId").attr("disabled",false);
...
HpfUtil.prototype.ajclick = function()
{
	if($("#ajId").is(":checked"))
	{
		$("#qsNumId").attr("disabled",false);
...
HpfUtil.prototype.nyclick = function()
{
	if($("#nyId").is(":checked"))
	{
		$("#nsNumId").attr("disabled",false);
...
HpfUtil.prototype.nistsubmint = function()
{
	var obj 	= {};
...
HpfUtil.prototype.getTPDBId = function()
{
	return this.tpdbId;
}

HpfUtil.prototype.getLPDBId = function()
{
	return this.lpdbId;
}

HpfUtil.prototype.getCfgs = function()
{
	var isc = "";
	$("input[name=cfgs]").each(function()
	{ 
