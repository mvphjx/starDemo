...
function FootPrintCheck(qryId,pageNumLan)
{
    this.initParam();
    this.qryId 			= qryId;
...
FootPrintCheck.prototype.isFillScreen = false;
FootPrintCheck.prototype.loadFirstTT = true;//第一次加载TT 如果缺指位需要特殊处理
FootPrintCheck.prototype.candResults = {};//候选列表  认定结果缓存，防止翻页之后丢失 id：value
FootPrintCheck.prototype.firstPageFirstLoadDoNotNeedLoad = false;//优化避免重复加载
FootPrintCheck.prototype.init = function()
{
    this.defaultLayout();
    this.initButton();
    this.initCheckOcx();
...
/** 切换屏幕显示模式 */
FootPrintCheck.prototype.switchScreenMode = function()
{
...
FootPrintCheck.prototype.initParam = function()
{
    this.candTable 		= null;
...
FootPrintCheck.prototype.initButton = function()
{
    var nThis = this;
    ...
    this.imgOperTool = new ImageTool("ImgOper","ImageOcx",toolIdList,OCX.OcxType.EDIT);
}

/**
 * 退出全屏模式
 */
FootPrintCheck.prototype.exitFullScreen = function()
{
...
//        updateSliderLocation();
    ...
    $(".FgpFrame").animate({"width":"49%","height":ocxH + "px"},150);
 ...
 * 进入全屏模式
 */
FootPrintCheck.prototype.fullScreen = function()
{
    //hiddenSlider();
    ...
    $(".FgpFrame").animate({"width":"49%","height":ocxHeight+"px"},150);
    //上一下下一个候选等按钮显示
    $("#NextCand_Plus").show();
    $("#PrevCand_Plus").show();
    $("#ShowTable").show();
...
/** 自动调整控件尺寸 */
FootPrintCheck.prototype.defaultLayout = function()
{
    ...
    $("#CardTab").animate({"height":height+"px"},150);
    $("#SrcCardInfo").animate({"height":(height-40)+"px"},150);
    $("#CandCardInfo").animate({"height":(height-40)+"px"},150);
...
/** 完成认定 之前进行校验 无候选提示 */
FootPrintCheck.prototype.beforeFinishCheck = function(){
    var _this = this;
 ...
 * 重置页面
 */
FootPrintCheck.prototype.reSet = function()
{
    // 如果不清空页面则将候选列表右键菜单更新
...
/** 打开比对任务 */
FootPrintCheck.prototype.openMatch = function()
{
    if(this.matchDialog == null)
    {
        ...
        wheres.push(where);
        // var where1 = {};
        // where1.colName = QryTaskCol.BTY_MASK;
        // where1.dataType = ABISCode.StorageDataType.NUMBER;
        // where1.value1 = ABISCode.Bty.BTY_FOOT;
        // wheres.push(where1);
    ...
    function selectMatch(rows)
    {
        ...
        $("#SrcCard").focus();
        nThis.changeImageOcxcolor(nThis.srcImageOcx);
    }
}
/** 修改页面插件div选中状态*/
FootPrintCheck.prototype.changeImageOcxcolor = function (id) {
    if(id==this.srcImageOcx){
 ...
 * rows表示表格选中的行
 */
FootPrintCheck.prototype.openMatchTask = function(rows)
{
...
FootPrintCheck.prototype.open = function(qryId)
{
    var nThis = this;
...
// 切换比对任务
FootPrintCheck.prototype.switchMatchTask = function(matchInfo)
{
...
FootPrintCheck.prototype.updateSrcInfo = function(matchInfo)
{
    var qryObj	= matchInfo.qryObj;
    var taskInfo = qryObj.taskInfo;
...
FootPrintCheck.prototype.updateTPCardInfo = function(info,tpInfo)
{
...
FootPrintCheck.prototype.updateLPCardInfo = function(info,lpInfo)
{
...
FootPrintCheck.prototype.updateMatchTaskInfo = function(taskInfo)
{
    this.clearMatchTaskInfo();
...
/** 更新弹出菜单项文本 */
FootPrintCheck.prototype.updateMenuTxt = function()
{
...
/** 根据比对状态对象生成相应文本 */
FootPrintCheck.prototype.getStatusFlowTxt = function()
{
...
//切换候选
FootPrintCheck.prototype.switchCand = function(row)
{
...
FootPrintCheck.prototype.updateCandInfo = function(cardId)
{
...
FootPrintCheck.prototype.updateCandCache = function()
{
 ...
 *
 */
FootPrintCheck.prototype.syncSrcBfvc = function(row)
{
    var qryObj 		= this.matchInfo.qryObj;
    var qryType 	= qryObj.taskInfo.qryType;
...
FootPrintCheck.prototype.syncSrcAndDstBfvc = function(type)
{
...
FootPrintCheck.prototype.initCandTable = function()
{
    var  nThis = this;
...
FootPrintCheck.prototype.initInfoUI = function()
{
...
FootPrintCheck.prototype.updateInfoUI = function(qryType)
{
...
FootPrintCheck.prototype.clearMatchTaskInfo = function()
{
    //比对信息
    $("#QryNum").html("");
    $("#QryType").html("");
 ...
 * 清空信息
 */
FootPrintCheck.prototype.clearInfo = function()
{
 ...
 * 根据比对ID检索比对候选
 */
FootPrintCheck.prototype.searchCandInfo = function()
{
    if(this.matchInfo == null)return;
...
FootPrintCheck.prototype.loadFirst = function()
{
    if(this.matchInfo == null)return;
...
FootPrintCheck.prototype.cacheTP = function(cardId,bty,vid, fgp, cid, gid, dataType, imgType, loc){//缓存图像
    if(cardId==null){
        return;
    }
    var obj 		= {};
...
FootPrintCheck.prototype.srcImageOcx = "ImageOcx";
FootPrintCheck.prototype.CandImageOcx = "CandImageOcx";

/** 初始化认定控件 */
FootPrintCheck.prototype.initCheckOcx = function()
{
    //
    this.imgOcx = document.getElementById(this.srcImageOcx);
    this.candImgOcx = document.getElementById(this.CandImageOcx);
    //控件点击后  切换操作对象
    this.imgOcx.HS_OCX_SetID(this.srcImageOcx);
    this.candImgOcx.HS_OCX_SetID(this.CandImageOcx);
    this.imgOcx.attachEvent('HS_OCX_NotifyMsgInfoEvent', ocxChange);
    this.candImgOcx.attachEvent('HS_OCX_NotifyMsgInfoEvent', ocxChange);
    var _this = this;
    function ocxChange(id,mid,nx,ny ){
        if(mid===OCX.OcxMouseMessage.OCX_WM_LBUTTONDOWN){
            _this.imgOperTool.setImgId(id);
            _this.changeImageOcxcolor(id);
        }
    }
    ...
    if ( !WebUtil.isNull(this.candImgOcx) )
    {
        this.candImgOcx.HS_OCX_SetBackColor(WebVar.ImgOcxBg);
    }
}

FootPrintCheck.prototype.searchTP = function(cardId,bty,vid, fgp, cid, gid, dataType, imgType, loc,isCand)
{
    var nThis = this;
    if(cardId==null){
        // 左边的是0, 0, 右边的候选是0, 1
            ...
            if (data != null)
            {
                ...
                if (data.img != null)
                {
                    ...
                    if (!WebUtil.isEmpty(data.img.item))
                    {
                        ...
                        img = imgItem.data;
                        if(isCand){
                            nThis.candImgOcx.HS_OCX_SetImageMnt(img, "", "", "");
                        }else{
...
//缓存图像信息
FootPrintCheck.prototype.cacheLP = function(cardId, bty, cid, dataType, imgType, gid, loc){
    if(cardId == null)return;
    var obj 	= {};
    obj.bty 	= bty;
    obj.cid 	= cid;
...
FootPrintCheck.prototype.searchLP = function(cardId, bty, cid, dataType, imgType, gid, loc,isCand)
{
    if(cardId == null)return;
    var obj 	= {};
    obj.bty 	= bty;
...
FootPrintCheck.prototype.selectedSrcFgp = function(id, bty, vid, fgp, cid, imgType, mntId)
{
...
/** 切换候选卡指位*/
FootPrintCheck.prototype.selectedDstFgp = function(id, bty, vid, fgp, cid, imgType, mntId)
{
    this.searchBfvc(this.dstCardId, bty, vid, fgp, cid, imgType, mntId, true);
}

FootPrintCheck.prototype.searchBfvc = function(cardId, bty, vid, fgp, cid, imgType, mntId,isCand)
{
    if(cardId==null){
        return;
    }
...
//    var imgExists = this.imgOcx.HS_OCX_LobIsExist(cardId, isTP, bty, fgp, vid, ABISCode.LobDataType.IMG, imgType,
// cid);
...
/*展示候选列表*/
FootPrintCheck.prototype.showTable = function(){
    var e = $('#DownArea');
...
/*弹出候选列表*/
FootPrintCheck.prototype.alertTable = function(){
    var e = $('#DownArea');
    e.show();
    var d = dialog({
        id: 'EF893L1',
...
/*弹出图像工具*/
var d;
FootPrintCheck.prototype.showTool = function(){
    if(d){
        d.open&&d.close();
        return false;
    }
