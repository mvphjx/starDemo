...
function QingDaoStat(id,array,searchStr)
{
	this.id = id;
	this.array = array;
...
QingDaoStat.prototype.init = function()
{
	
	var tit1 = "<tr><td colspan=\"2\" rowspan=\"5\" class=\"titX\">单位　项目</td><td colspan=\"10\" class=\"titS\">捺印指纹搜集与管理</td><td colspan=\"5\" class=\"titS\">现场指纹</td><td colspan=\"14\" class=\"titS\">指纹应用</td>" +
