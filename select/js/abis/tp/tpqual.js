...
TPQual.prototype.getSwitch = function()
{
	return this.scFactory.getSwitchControl();
}

TPQual.prototype.init = function()
{
...
TPQual.prototype.getQualReason = function(id)
{
...
TPQual.prototype.refresh = function()
{
...
TPQual.prototype.load = function()
{
...
TPQual.prototype.switchFgp = function(bty, vid, fgp, cid, imgType, gid)
{
...
TPQual.prototype.showQuality = function ()
{
	//图像质量和特征
...
TPQual.prototype.strToJson = function (str)
{ 
	var json;
...
TPQual.prototype.layout = function()
{
	var nThis = this;
...
TPQual.prototype.setCardId = function(cardId)
{
	this.tpCardId = cardId;
}

TPQual.prototype.setLayoutType = function(layoutType)
{
	this.layoutType = layoutType;
}

TPQual.prototype.getLayoutType = function()
{
