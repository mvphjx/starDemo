TextSwitchControl.DownDelay 	= 150;
TextSwitchControl.Bty 			= "Bty";
TextSwitchControl.Vid 			= "Vid";
TextSwitchControl.Fgp 			= "Fgp";
TextSwitchControl.ImgId 		= "ImgId";
TextSwitchControl.Gid 			= "Gid";
TextSwitchControl.Layout 		= "Layout";
TextSwitchControl.Cid 			= "Cid";
TextSwitchControl.ImgIdCombo 	= "ImgIdCombo";
TextSwitchControl.GidCombo 		= "GidCombo";
TextSwitchControl.PrevNaviBnt 	= "PrevNaviBnt";
TextSwitchControl.NextNaviBnt 	= "NextNaviBnt";
TextSwitchControl.Tree 			= "Tree";
TextSwitchControl.Logo 			= "Logo";
TextSwitchControl.Undefined 	= "undefined";
 ...
 */
function TextSwitchControl(id, fiveList, ImgIdList, invoke, treeId, treeData, bty, vid, fgp, cid, imgId, gid)
{
	this.id 			= id;
	this.btyId 			= this.id + TextSwitchControl.Bty;
	this.vidId 			= this.id + TextSwitchControl.Vid;
	this.fgpId 			= this.id + TextSwitchControl.Fgp;
	this.imgIdId 		= this.id + TextSwitchControl.ImgId;
	this.gidId 			= this.id + TextSwitchControl.Gid;
	this.layoutId 		= this.id + TextSwitchControl.Layout;
	this.cidId			= this.id + TextSwitchControl.Cid;
	this.imgComboId	 	= this.id + TextSwitchControl.ImgIdCombo;
	this.groupComboId 	= this.id + TextSwitchControl.GidCombo;
	this.logoId 		= this.id + TextSwitchControl.Logo;
	this.gPrevBntId 	= this.id + TextSwitchControl.PrevNaviBnt;
	this.gNextBntId 	= this.id + TextSwitchControl.NextNaviBnt;
...
TextSwitchControl.prototype.initParam = function()
{
...
TextSwitchControl.prototype.initIframe = function(){
//先加载iframe
	var _this = this;
 ...
 * 初始化方法[外界不要调用]
 */
TextSwitchControl.prototype.init = function()
{
	this.initIframe();
	var _this = this;
	this.hasInit = true;
...
TextSwitchControl.prototype.initImgIdType = function()
{
...
TextSwitchControl.prototype.initLayoutType = function()
{
 ...
 * 应用显示数据的模式（TP|LP)
 */
TextSwitchControl.prototype.applyDisMode = function()
{
	var cssName 	= "hidden";
 ...
 * 初始化数据
 */
TextSwitchControl.prototype.initData = function()
{
	//初始化生物特征列表
	this.initBtyList();
...
/** 设置布局回调函数 */
TextSwitchControl.prototype.setLayoutInvoke = function(layoutInvoke)
{
 ...
 * 五要素改变时候调用此方法来更新控件
 */
TextSwitchControl.prototype.setData = function(fiveList, treeData, bty, vid, fgp, cid, gid)
{
	this.bty 		= bty;
	this.vid 		= vid;
	this.fgp 		= fgp;
...
TextSwitchControl.prototype.set6E = function(bty, vid, fgp, cid, imgId, gid)
{
	this.bty 		= bty;
	this.vid 		= vid;
	this.fgp 		= fgp;
...
TextSwitchControl.prototype.set5E = function(bty, vid, fgp, cid, gid)
{
	this.bty 		= bty;
	this.vid 		= vid;
	this.fgp 		= fgp;
...
TextSwitchControl.prototype.initTree = function()
{
	if (this.treeId == null || this.treeId == TextSwitchControl.Undefined) { return; }
	var nThis = this;
	var settings =
	{
	    data :
	...
	function onDoubleClick(e, tid, node)
	{
		...
		$tree.slideUp(TextSwitchControl.DownDelay);
	}
...
TextSwitchControl.prototype.refreshTree = function()
{
...
TextSwitchControl.prototype.reSet = function()
{
	this.fiveList = null;
	this.treeData = null;
	this.initTree();
 ...
 * 初始化布局类型列表
 */
TextSwitchControl.prototype.initLayoutList = function()
{
	//初始化数据
	this.initLayoutType();
 ...
 * 初始化图像样式下拉列表
 */
TextSwitchControl.prototype.initImgIdList = function()
{
	//初始化所需数据
	this.initImgIdType();
...
TextSwitchControl.prototype.switchBty = function()
{
...
TextSwitchControl.prototype.initgidComboList = function()
{
...
TextSwitchControl.prototype.initGidList = function()
{
...
TextSwitchControl.prototype.switchFgp = function()
{
...
TextSwitchControl.prototype.switchGid = function(){
	
}
TextSwitchControl.prototype.switchVid = function()
{
...
TextSwitchControl.prototype.addItem = function($parent, text, value, obj, id, cardId)
{
...
TextSwitchControl.prototype.initDownList = function(listId,callback)
{
	var _this = this;
...
TextSwitchControl.prototype.initBtyList = function()
{
	...
	if (firstText == null)
	{
		if (_this.fiveList != null && _this.fiveList.length > 0)
		{
            for ( var i = 0; i < _this.fiveList.length; i++)
            {
            	if(_this.fiveList[i].bty==10){
                    _this.bty = _this.fiveList[i].bty;
                    firstText = _this.fiveList[i].btyText;
				}
            }
		}
		else
 ...
 */
TextSwitchControl.prototype.clickItem = function(id, item)
{
	this.hiddenAll();
...
TextSwitchControl.prototype.initImgIdComboList = function()
{
...
TextSwitchControl.prototype.switchLayout = function()
{
	
}

TextSwitchControl.prototype.notifyChange = function()
{
	if(this.invoke)
	{
...
TextSwitchControl.prototype.hiddenAll = function()
{
	this.hiddenOtherList(null);
}

TextSwitchControl.prototype.hiddenOtherList = function(id)
{
	...
	controls.each(function(i)
	{
		if ($(this).attr("id") != id)
		{
			...
			$frame.slideUp(TextSwitchControl.DownDelay);
		}
	});
	...
	$trees.each(function(i)
	{
		...
		if (treeId != id)
		{
			...
			if (!$logo.is(":hidden"))
			{
				...
				$logo.attr("class", flag + "logo");
				$(this).slideUp(TextSwitchControl.DownDelay);
			}
		}
	});
 ...
 * 初始化事件
 */
TextSwitchControl.prototype.initEvent = function()
{
	var obj = this;
	...
	this.frameList[TextSwitchControl.Tree] 	= this.treeId;
}

TextSwitchControl.prototype.registerLayoutTypeEvent = function()
{
	...
	$bnt.mousedown(function()
	{
		if(f.is(":hidden"))
		{
			...
			f.slideToggle(TextSwitchControl.DownDelay);
		...
		{
			f.slideUp(TextSwitchControl.DownDelay);
			$(this).attr("class","layout_bnt_hover");
		}
    });
}

TextSwitchControl.prototype.registerImgIdEvent = function()
{
...
TextSwitchControl.prototype.registerMntIdEvent = function()
{
...
/** 注册树形控件显隐事件
 */
TextSwitchControl.prototype.registerLogoEvent = function()
{
	...
	$logo.mousedown(function()
	{
		...
		$tree.slideToggle(TextSwitchControl.DownDelay);
	});
}
 ...
 * 注册图像浏览方式下拉列表的点击事件 
 */
TextSwitchControl.prototype.registerImgId = function()
{
 ...
 * 注册全局导航按钮事件
 */
TextSwitchControl.prototype.registerNavigate = function()
{
...
TextSwitchControl.prototype.navigateClick = function(op)
{
...
TextSwitchControl.prototype.getIndex = function($node, value)
{
	var index = -1;
...
TextSwitchControl.prototype.execNavigate = function(id, value, op)
{
...
TextSwitchControl.prototype.registerLockEvent = function(listId)
{
...
TextSwitchControl.prototype.execNaviagte = function(listId, content, text, op)
{
	var value = null;
...
TextSwitchControl.prototype.registerDropDown = function(id)
{
	var parent = this.switchControl.find("#" + id);	
	...
	bnt.mousedown(function(e)
	{
		...
		else
		{
			...
			$frame.slideDown(TextSwitchControl.DownDelay, function()
			{
				var v;
			    if (id == obj.btyId)
			    {
...
TextSwitchControl.prototype.registerList = function($content)
{
...
TextSwitchControl.prototype.getFgpText = function(bty, vid, fgp)
{
	var fiveE;
	var viewObj;
	var f;
...
TextSwitchControl.prototype.getCid = function()
{
	return this.cid;
}

TextSwitchControl.prototype.setCid = function(cid)
{
	this.cid = cid;
}
TextSwitchControl.prototype.getBty = function()
{
	return this.bty;
}

TextSwitchControl.prototype.setBty = function(bty)
{
	this.bty = bty;
}

TextSwitchControl.prototype.getVid = function()
{
	return this.vid;
}

TextSwitchControl.prototype.setVid = function(vid)
{
	this.vid = vid;
}

TextSwitchControl.prototype.getFgp = function()
{
	return this.fgp;
}

TextSwitchControl.prototype.setFgp = function(fgp)
{
	this.fgp = fgp;
}
TextSwitchControl.prototype.getImgId = function()
{
	return this.imgId;
}

TextSwitchControl.prototype.setImgId = function(ImgId)
{
	this.imgId = ImgId;
}

TextSwitchControl.prototype.getGid = function()
{
	return this.gid;
}

TextSwitchControl.prototype.setGid = function(gid)
{
	this.gid = gid;
}
TextSwitchControl.prototype.getType = function()
{
	return this.type;
}

TextSwitchControl.prototype.setType = function(type)
{
	this.type = type;
}
TextSwitchControl.prototype.setIsMatch = function(isMatch)
{
	this.isMatch = isMatch;
}


TextSwitchControl.prototype.isInit = function()
{
	return this.hasInit;
}

TextSwitchControl.prototype.setChangeListener = function(listener)
{
	this.invoke = listener;
}

TextSwitchControl.prototype.showLayoutBnt = function()
{
	var layoutBnt	= $("#" + this.layoutId);
	layoutBnt.show();
}

TextSwitchControl.prototype.hideLayoutBnt = function()
{
	var layoutBnt	= $("#" + this.layoutId);
	layoutBnt.hide();
}
 ...
 *vidList.fgpList  指位
 */
TextSwitchControl.prototype.validate = function(bty,vid,fgp){
 ...
 * {bty,vid,fgp,cid}
 */
TextSwitchControl.prototype.getFristSyn = function(treeData2,p){
	var nThis = this;
