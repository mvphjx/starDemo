...
var LinkButtonCfg =
{
    ...
    Recovery		:   {normal:"Recovery",		hover:"Recovery_Large",			disable:"Recovery",			txt:""},
	...
	Detail		:	{normal:"Detail",		hover:"Detail_Large",		disable:"Detail",		txt:""},
    File		:	{normal:"File",		hover:"File_Large",		disable:"File",		txt:""},
    QueueTask		:	{normal:"QueueTask",		hover:"QueueTask_Large",		disable:"QueueTask_Large",	txt:""},
    SubDbConfig		:	{normal:"SubDbConfig",		hover:"SubDbConfig_Large",		disable:"SubDbConfig_Large",txt:""},
    TransferDb		:	{normal:"TransferDb",		hover:"TransferDb_Large",		disable:"TransferDb_Large",txt:""},
	...
	setLanguage	: function(language)
	{
        ...
        this.Recovery.txt 		= language.Recovery;
		...
		this.Detail.txt	= language.Detail;
        this.File.txt	= language.NoticeFile;
        this.QueueTask.txt 		= language.QueueTask;
        this.SubDbConfig.txt 		= language.SubDbConfig;
        this.TransferDb.txt 		= language.TransferDb;
	}
}