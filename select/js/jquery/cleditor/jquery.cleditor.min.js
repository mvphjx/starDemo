...
["Header 3","<h3>"],["Header 4","<h4>"],["Header 5","<h5>"],["Header 6","<h6>"]],useCSS:false,docType:'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">',docCSSFile:"",bodyStyle:"margin:4px; font:10pt Arial,Verdana; cursor:text"},buttons:{init:"bold,加粗,|italic,斜体,|underline,下划线,|strikethrough,中线,|subscript,下标,|superscript,上标,|font,字体,fontname,|size,字体大小,fontsize,|style,风格,formatblock,|color,字体颜色,forecolor,|highlight,背景颜色,hilitecolor,color|removeformat,取消格式化,|bullets,列表,insertunorderedlist|numbering,数字列表,insertorderedlist|outdent,左缩进,|indent,右缩进,|alignleft,居左,justifyleft|center,居中,justifycenter|alignright,居右,justifyright|justify,自适应,justifyfull|undo,撤销,|redo,反撤销,|rule,插入横线,inserthorizontalrule|image,插入图片,insertimage,url|link,插入链接,createlink,url|unlink,删除链接,|cut,裁剪,|copy,拷贝,|paste,粘贴,|pastetext,文本粘贴,inserthtml,|print,打印,|source,源码"},
