		...
		for ( var j = 0; j < colCount; j++) {
			...
			if(content_td!=null){
				...
				if(typeof td_showdiv =="undefined " || td_showdiv==null){
					td_showdiv = $("<div class=mydiv id=td_showdiv ></div>");
					td_showdiv.css("width","100px").css("height","auto").css("background","#fdebd0").css("position","absolute").css("display","none").css("padding","5px 10px").css("word-wrap","break-word");
